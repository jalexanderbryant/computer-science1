...
/* Function Prototypes */
Node read_file(Node db_head, char *filename );
...
{
	// Ensure user supplies the input file
	if( argc < 2 ) die("USAGE: assignment1 <input file>");
	...
	database = read_file( database,  argv[1] );
